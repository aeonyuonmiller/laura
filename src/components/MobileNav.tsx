                    ...
                    <AnimatePresence>
                        {show ? (
                            <motion.svg
                                ...
                                exit={{ scale: 0, rotate: -30 }} width="40" viewBox="0 0 150 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <motion.svg
                                ...
                                animate={{ scale: 1, rotate: 0 }}
                                exit={{ scale: 0, rotate: -30 }} width="40" viewBox="0 0 150 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M97.9767 65.1245L72.2167 67.4246L22.5367 67.4246L19.3167 62.5945L21.1567 56.8445L20.0067 42.5845L22.9967 39.1345L83.7167 43.5045L113.387 43.5045L121.207 45.3445L130.637 63.0546L128.797 65.8145L107.407 65.8145L100.047 63.9745L97.9767 65.1245Z" fill="#00000080" />
                                <path d="M51.9764 109.415L77.7364 111.715L127.416 111.715L130.636 106.885L128.796 101.135L129.946 86.8746L126.956 83.4246L66.2364 87.7946L36.5664 87.7946L28.7464 89.6346L19.3164 107.345L21.1564 110.105L42.5464 110.105L49.9064 108.265L51.9764 109.415Z" fill="#00000080" />
                            </motion.svg>
                        )}
                    </AnimatePresence>
                </motion.button>
