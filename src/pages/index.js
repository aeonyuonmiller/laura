    ...
    <>
      ...
      <Transition backgroundColor={"#B0AD98"}>
        ...
        <section className="points">
          <Bound>
            ...
            <h2>
              ...
              <br /><br />
              Schildere dein Anliegen, und ich werde mich zeitnah bei dir zurückmelden. 
              <br /><br/>
        ...
        <section className="two-grid">
            ...
            <h2>Laura Maria Müller seit 2012 in Darmstadt lebend, 1993 im Rhein-Main-Gebiet geboren, fand ich früh den Weg zur Musik.</h2>
            <p>
              Über das Singen mit meiner Mama, verfolgte ich meine Leidenschaft für den Gesang in zahlreichen Schulchören, und nahm zwei Jahre lang Keyboardunterricht. Mit 15 Jahren gründeten einige Schulfreund/Innen und ich unsere erste Band, in der ich als Sängerin und Songwriterin tätig war.
            </p>
            <p>  
              Seither, probierte ich mich mit den verschiedensten Instrumenten (Gitarre, Ukulele, Kalimba, Glockenspiele, unterschiedliche Percussioninstrumente, und Software am Computer u.a. Fruity Loops und Ableton) aus und war Teil verschiedener Bandprojekte und verfolgte meinen Weg als Solokünstlerin.
            </p>
